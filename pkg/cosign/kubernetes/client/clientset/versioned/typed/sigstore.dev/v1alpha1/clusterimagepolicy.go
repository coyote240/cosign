...
import (
	...
	scheme "github.com/sigstore/cosign/pkg/cosign/kubernetes/client/clientset/versioned/scheme"
...
type ClusterImagePoliciesGetter interface {
	ClusterImagePolicies(namespace string) ClusterImagePolicyInterface
}
...
func newClusterImagePolicies(c *SigstoreV1alpha1Client, namespace string) *clusterImagePolicies {
