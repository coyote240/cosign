...
type FakeClusterImagePolicies struct {
	Fake *FakeSigstoreV1alpha1
	ns   string
}

var clusterimagepoliciesResource = schema.GroupVersionResource{Group: "sigstore.dev", Version: "v1alpha1", Resource: "clusterimagepolicies"}

var clusterimagepoliciesKind = schema.GroupVersionKind{Group: "sigstore.dev", Version: "v1alpha1", Kind: "ClusterImagePolicy"}
...
func (c *FakeClusterImagePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterImagePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(clusterimagepoliciesResource, c.ns, name), &v1alpha1.ClusterImagePolicy{})
...
func (c *FakeClusterImagePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterImagePolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(clusterimagepoliciesResource, clusterimagepoliciesKind, c.ns, opts), &v1alpha1.ClusterImagePolicyList{})
...
func (c *FakeClusterImagePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(clusterimagepoliciesResource, c.ns, opts))
...
func (c *FakeClusterImagePolicies) Create(ctx context.Context, clusterImagePolicy *v1alpha1.ClusterImagePolicy, opts v1.CreateOptions) (result *v1alpha1.ClusterImagePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(clusterimagepoliciesResource, c.ns, clusterImagePolicy), &v1alpha1.ClusterImagePolicy{})
...
func (c *FakeClusterImagePolicies) Update(ctx context.Context, clusterImagePolicy *v1alpha1.ClusterImagePolicy, opts v1.UpdateOptions) (result *v1alpha1.ClusterImagePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(clusterimagepoliciesResource, c.ns, clusterImagePolicy), &v1alpha1.ClusterImagePolicy{})
...
func (c *FakeClusterImagePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(clusterimagepoliciesResource, c.ns, name), &v1alpha1.ClusterImagePolicy{})
...
func (c *FakeClusterImagePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(clusterimagepoliciesResource, c.ns, listOpts)
...
func (c *FakeClusterImagePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterImagePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clusterimagepoliciesResource, c.ns, name, pt, data, subresources...), &v1alpha1.ClusterImagePolicy{})
