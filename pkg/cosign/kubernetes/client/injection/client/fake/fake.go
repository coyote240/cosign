...
import (
	...
	fake "github.com/sigstore/cosign/pkg/cosign/kubernetes/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/sigstore/cosign/pkg/cosign/kubernetes/client/clientset/versioned/fake.Clientset from context.")
	}
