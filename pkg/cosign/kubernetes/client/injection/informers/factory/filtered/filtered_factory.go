...
import (
	...
	externalversions "github.com/sigstore/cosign/pkg/cosign/kubernetes/client/informers/externalversions"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/sigstore/cosign/pkg/cosign/kubernetes/client/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
