...
import (
	...
	versionedscheme "github.com/sigstore/cosign/pkg/cosign/kubernetes/client/clientset/versioned/scheme"
	client "github.com/sigstore/cosign/pkg/cosign/kubernetes/client/injection/client"
	clusterimagepolicy "github.com/sigstore/cosign/pkg/cosign/kubernetes/client/injection/informers/sigstore.dev/v1alpha1/clusterimagepolicy"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "clusterimagepolicies.sigstore.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sigstore.dev.ClusterImagePolicy"),
	)
