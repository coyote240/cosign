...
type reconcilerImpl struct {
	...
	Lister sigstoredevv1alpha1.ClusterImagePolicyLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister sigstoredevv1alpha1.ClusterImagePolicyLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.ClusterImagePolicies(s.namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ClusterImagePolicy) (*v1alpha1.ClusterImagePolicy, error) {

	getter := r.Lister.ClusterImagePolicies(resource.Namespace)
	...
	patcher := r.Client.SigstoreV1alpha1().ClusterImagePolicies(resource.Namespace)
